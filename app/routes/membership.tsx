...
const plans = [
  ...
  },
  {
    ...
    icon: Star,
    name: "Xén Rise",
    tagline: "Most popular — 4 classes a month",
  ...
  },
  {
    ...
    icon: Crown,
    name: "Xén Elevate",
    tagline: "Best value — 8 classes a month",
  ...
  },
  {
    ...
    icon: Crown,
    name: "Xén Ultimate",
    tagline: "16 classes a month",
    price: { monthly: "180", annual: "180" },
    unit: "per month",
    highlight: false,
    badge: "Ultimate",
    features: [
      ...
      "Cafe discount (10%)",
      "Monthly goody bag",
      "1 free class pass for a friend",
    ],
    notIncluded: [],
    cta: "Book Now",
